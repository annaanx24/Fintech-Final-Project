...
function screen3() {
  ...
  if (selectedItem == "iPad") {
    popup.clear();
    popup.background("rgba(0, 0, 0, 0.60)");
...
class Prize {
  ...
  displayPrize() {
    ...
    text(`${tempName} | ${this.price} coins`, this.x + 100, this.y + 210);
    // text(this.price +" coins", this.x+100, this.y+225)
  }

  displayCollection() {
    if (this.name == "legos") {
      text(`You have ${this.count} ${this.name}!`, this.x + 100, this.y + 210);
    } 
    else if (this.name == "candy") {
      text(`You have ${this.count} candies!`, this.x + 100, this.y + 210);
    }
    else {
      text(`You have ${this.count} ${this.name}s!`, this.x + 100, this.y + 210);
    }
  }
